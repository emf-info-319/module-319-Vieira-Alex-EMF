public class VeiraE00 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            System.out.println(nomEquipe1 + " joue contre Madrid et le resultat est : " + scoreEquipe1 + " à " + scoreEquipe2);

            if (scoreEquipe1 > scoreEquipe2) {
                System.out.println(nomEquipe1 +" à gagner !");
                nombrePointEquipe1 = nombrePointEquipe1 + NOMBRE_PTS_VICTOIRE;
            }else{
                System.out.println("Madrid à gagner !");
        ...
        System.out.println("Barcelone a " + nombrePointEquipe1 + " points");
        System.out.println("Madrid a " + nombrePointEquipe2 + " points");
    }
}
